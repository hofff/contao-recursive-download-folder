...
$GLOBALS['TL_LANG']['tl_module']['recursiveDownloadFolderModes']['breadcrumb'][0] = 'Ordnerbasiert mit Pfadnavigation';
$GLOBALS['TL_LANG']['tl_module']['recursiveDownloadFolderModes']['breadcrumb'][1] = '';
$GLOBALS['TL_LANG']['tl_module']['recursiveDownloadFolderModes']['toggleable'][0] = 'Aufklappbarer Ordnerbaum';
$GLOBALS['TL_LANG']['tl_module']['recursiveDownloadFolderModes']['toggleable'][1] = '';
