...
$GLOBALS['TL_DCA']['tl_module']['palettes']['__selector__'][] = 'recursiveDownloadFolderAllowFileSearch';
...
$GLOBALS['TL_DCA']['tl_module']['subpalettes']['recursiveDownloadFolderAllowFileSearch'] = 'recursiveDownloadFolderShowAllSearchResults';
...
$GLOBALS['TL_DCA']['tl_module']['fields']['recursiveDownloadFolderZipDownload'] = [
    'label'     => &$GLOBALS['TL_LANG']['tl_module']['recursiveDownloadFolderZipDownload'],
    'exclude'   => true,
    'inputType' => 'checkbox',
    'eval'      => ['tl_class' => 'w50'],
    'sql'       => "char(1) NOT NULL default ''",
...
$GLOBALS['TL_DCA']['tl_module']['fields']['recursiveDownloadFolderShowAllSearchResults'] = [
    'label'     => &$GLOBALS['TL_LANG']['tl_module']['recursiveDownloadFolderShowAllSearchResults'],
    'exclude'   => true,
    'inputType' => 'checkbox',
    'eval'      => ['tl_class' => 'w50'],
    'sql'       => "char(1) NOT NULL default ''",
